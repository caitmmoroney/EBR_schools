...
abstract: |
  In this project, I examine the spatial relationships between school performance and socioeconomic variables, such as race and income. I take as a case study for my analysis the region of East Baton Rouge Parish in southern Louisiana. I conduct two sets of analyses, one taking census block groups as the unit of analysis. These analyses consist of variations on the Local Moran's I which help to identify statistically significant spatial autocorrelation. The second set of analyses are regression models which use schools as the unit of analysis. I conduct both OLS regression and spatial regression, including the spatial error model and spatial lag model. From the Local Moran's analyses, I find statistically significant clusters of the white percentage of the population, median household income, and the collocation of these variables across census block groups. My regression analyses diverge in the selection of dependent variable. The models which seek to predict the percentage of economically disadvantaged students suggest that there is a statistically significant negative relationship between the percentage of white students and the percentage of economically disadvantaged students. The models which take school performance scores as the dependent variable produce evidence of a statistically significant postiive relationship between school performance and the percentage of white students.
...
I hypothesize that the white population tends to cluster in areas that fall under the splinter school districts or the City of St. George, whereas the denser urban part of the Parish will have a higher share of minorities.

* Is there evidence of the clustering of income levels in EBR Parish?

I hypothesize that areas covered by the splinter school districts and the City of St. George will tend to have higher income levels, on average, than areas in the EBR Parish School District.

* Is there evidence of a spatial relationship between race and income?

I expect that areas with a higher share of white residents will tend to have higher income levels, on average.

* Is there evidence to suggest that school performance is linked to the racial makeup of the student body and/or the percentage of students fully proficient in English?

I hypothesize that school performance has a positive relationship with the percentage of white students, ceteris paribus. I also expect that school performance has a positive relationship with the percentage of students fully proficient in English, ceteris paribus.

* Is there evidence to suggest that the percentage of economically disadvantaged students is related to the percentage of white students and/or the share of English-proficient students?

I expect that both of these explanatory variables are negatively related to the percentage of economically disadvantaged students.
...
My next set of analyses address my hypotheses that the percentage of economically disadvantaged students is related to the percentage of white students and/or the percentage of students who are fully proficient in English. The last variable was not statistically significant, so I reject my original hypothesis on the relationship between economically disadvantaged students and students fully proficient in English. However, the results do suggest that there is a negative relationship between the percentage of economically disadvantaged students and the percentage of white students, as I anticipated.
