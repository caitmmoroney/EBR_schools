...
![](../spatial_regression/economically_disadvantaged/reg1_ols.png){width=80% height=80%}

![](../spatial_regression/economically_disadvantaged/reg2_ols.png){width=80% height=80%}

### Spatial Regression

![Spatial error model.](../spatial_regression/economically_disadvantaged/spatial_error_model.png){width=80% height=80%}

![Spatial lag model.](../spatial_regression/economically_disadvantaged/spatial_lag_model.png){width=80% height=80%}

## School Performance Scores

### OLS

![](../spatial_regression/school_performance_2018/SPS_vs_all_minusED/reg5_ols.png){width=80% height=80%}

![](../spatial_regression/school_performance_2018/SPS_vs_all_minusED/reg6_ols.png){width=80% height=80%}

### Spatial Regression

![Spatial error model.](../spatial_regression/school_performance_2018/SPS_vs_all_minusED/spatial_error_model.png){width=80% height=80%}

![Spatial lag model.](../spatial_regression/school_performance_2018/SPS_vs_all_minusED/spatial_lag_model.png)
