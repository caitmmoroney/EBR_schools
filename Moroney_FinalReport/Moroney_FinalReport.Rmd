...
The rest of the paper is organized as follows: in Section \ref{sec:methods} I cover the methodology used in this analysis, in Section \ref{sec:results} I report the results, and in Section \ref{sec:discuss} I discuss the findings.
